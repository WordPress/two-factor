 ...
 * Description:       Habilite a Autenticação de Dois Fatores usando senhas únicas baseadas em tempo, Universal 2nd Factor (FIDO U2F, YubiKey), email e códigos de verificação de backup.
 * Version:           0.13.0
