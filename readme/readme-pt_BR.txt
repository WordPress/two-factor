=== Two-Factor ===
Contributors: georgestephanis, valendesigns, stevenkword, extendwings, sgrant, aaroncampbell, johnbillion, stevegrunwell, netweb, kasparsd, alihusnainarshad, passoniate, fabriciosilvasantos
...
O melhor lugar para reportar bugs, sugestões de recursos ou qualquer outro feedback (não relacionado à segurança) é na <a href="https://github.com/WordPress/two-factor/issues">página de issues do Two Factor no GitHub</a>. Antes de enviar um novo issue, por favor, pesquise os issues existentes para verificar se alguém já reportou o mesmo feedback.
