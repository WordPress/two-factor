...
class Two_Factor_Backup_Codes extends Two_Factor_Provider {
	...
	public function authentication_page( $user ) {
		...
		<p>
			...
			<input type="text" inputmode="numeric" name="two-factor-backup-code" id="authcode" class="input authcode" value="" size="20" pattern="[0-9 ]*" placeholder="1234 5678" autocomplete="off" data-digits="8" />
		</p>
		<?php
