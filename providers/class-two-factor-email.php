...
class Two_Factor_Email extends Two_Factor_Provider {
	...
	public function authentication_page( $user ) {
		...
		<p>
			...
			<input type="text" inputmode="numeric" name="two-factor-email-code" id="authcode" class="input authcode" value="" size="20" pattern="[0-9 ]*" autocomplete="off" placeholder="1234 5678" data-digits="8" />
